...
{
    public sealed class SearchProductControllerTests
    {
        ...
        [Fact]
        public void FilterProductsCart_QueryWithProducent()
        {
            //Arrange
            ProductSearchVM productVM = new();
            ...
            productVM.ProducentIdList = new List<string>() { "Test producent" };
            //Act
            var query = _sut.FilterProductsCart(productVM) as ViewResult;
        ...
        [Fact]
        public void FilterProductsCart_QueryWithPrice()
        {
            //Arrange
            ProductSearchVM productVM = new();
