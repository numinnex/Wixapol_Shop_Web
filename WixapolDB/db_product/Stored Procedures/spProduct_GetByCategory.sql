CREATE PROCEDURE [db_product].[spProduct_GetByCategory]
@CategoryId int,
...
begin
	...
	inner join db_product.Producent as x on p.ProducentId = x.Id where p.CategoryId = @CategoryId and p.[Name] + c.[Name] + x.[Name] like '%' + @NamePattern + '%'; 
	end
